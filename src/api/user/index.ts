...
): Promise<UpdateUserReply> {
  return request.PUT<UpdateUserReply>(
    `/v1/user/update/${params.id}`,
    params.data
  )
}
...
export function batchUpdateUserStatus(
  params: BatchUpdateUserStatusRequest
): Promise<BatchUpdateUserStatusReply> {
...
): Promise<ResetUserPasswordReply> {
 ...
 */
export function resetUserPasswordBySelf(
  params: ResetUserPasswordBySelfRequest
): Promise<ResetUserPasswordBySelfReply> {
  return request.PUT<ResetUserPasswordBySelfReply>(
...
): Promise<GetUserSelectListReply> {
...
export function updateUserEmail(
  params: UpdateUserEmailRequest
): Promise<UpdateUserEmailReply> {
 ...
 */
export function updateUserBaseInfo(
  params: UpdateUserBaseInfoRequest
): Promise<UpdateUserBaseInfoReply> {
